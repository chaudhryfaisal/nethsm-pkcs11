...
// Global backend instance - this will be initialized during C_Initialize
pub static BACKEND: ArcSwapOption<Mutex<SyncBackendWrapper>> = ArcSwapOption::const_empty();
